...
export function VaultSetup({ onNavigate }) {
    ...
    return (_jsxs(Page, { title: "Setup", breadcrumbs: breadcrumbs, onNavigate: navigate, description: "Configure webhooks for SMS (F-Droid) and Email (Power Automate) forwarding", children: [error && (_jsx(Alert, { variant: "error", title: "Error", children: error.message })), otpSubscription.otpCode && (_jsx(Card, { className: "border-2 border-green-500 bg-green-50 dark:bg-green-900/20", children: _jsxs("div", { className: "p-6", children: [_jsxs("div", { className: "flex items-start justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(CheckCircle2, { size: 24, className: "text-green-600 dark:text-green-400" }), _jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold text-green-900 dark:text-green-100", children: "OTP Code Received" }), _jsxs("p", { className: "text-sm text-green-700 dark:text-green-300", children: [otpSubscription.latestNotification?.type === 'email' ? 'Email' : 'SMS', " from ", otpSubscription.latestNotification?.from, otpSubscription.latestNotification?.subject && ` - ${otpSubscription.latestNotification.subject}`] })] })] }), _jsx(Button, { variant: "ghost", size: "sm", onClick: () => {
                                        otpSubscription.clearOtp();
                                    }, children: _jsx(X, { size: 16 }) })] }), _jsx("div", { className: "flex items-center gap-4 mb-4", children: _jsxs("div", { className: "flex-1", children: [_jsxs("div", { className: "flex items-baseline gap-3", children: [_jsx("code", { className: "text-4xl font-mono font-bold text-green-900 dark:text-green-100", children: otpSubscription.otpCode }), _jsxs(Button, { variant: "secondary", size: "sm", onClick: () => {
                                                    navigator.clipboard.writeText(otpSubscription.otpCode);
                                                }, className: "flex items-center gap-2", children: [_jsx(Copy, { size: 16 }), "Copy"] })] }), _jsxs("div", { className: "mt-2 flex items-center gap-2", children: [_jsxs("span", { className: `text-xs font-medium px-2 py-1 rounded ${otpSubscription.otpConfidence === 'high'
                                                    ? 'bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200'
                                                    : otpSubscription.otpConfidence === 'medium'
                                                        ? 'bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200'
                                                        : 'bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200'}`, children: [otpSubscription.otpConfidence, " confidence"] }), otpSubscription.latestNotification?.receivedAt && (_jsx("span", { className: "text-xs text-muted-foreground", children: new Date(otpSubscription.latestNotification.receivedAt).toLocaleString() }))] })] }) }), otpSubscription.fullMessage && (_jsxs("div", { className: "mt-4 pt-4 border-t border-green-200 dark:border-green-800", children: [_jsxs(Button, { variant: "ghost", size: "sm", onClick: () => {
  ...
  "timestamp": "2024-01-01T12:00:00Z"
                                            ...
                                            : 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800'}`, children: [_jsx("div", { className: "flex items-start justify-between mb-2", children: _jsxs("div", { className: "text-sm flex-1", children: [_jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [_jsx("span", { className: "font-medium", children: log.method }), log.url?.includes('/email/webhook') ? (_jsx("span", { className: "px-2 py-0.5 rounded text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 font-medium", children: "Email" })) : log.url?.includes('/sms/webhook') ? (_jsx("span", { className: "px-2 py-0.5 rounded text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 font-medium", children: "SMS" })) : null, _jsx("span", { className: `px-2 py-0.5 rounded text-xs ${log.success
                                                                        ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400'
                                                                        : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400'}`, children: log.statusCode || 'N/A' }), log.processingTimeMs !== null && log.processingTimeMs !== undefined && (_jsxs("span", { className: "text-xs text-muted-foreground", children: [log.processingTimeMs, "ms"] }))] }), _jsx("div", { className: "text-xs text-muted-foreground mt-1", children: new Date(log.receivedAt).toLocaleString() }), log.fromNumber && (_jsxs("div", { className: "text-xs text-muted-foreground mt-1", children: ["From: ", log.fromNumber, " \u2192 To: ", log.toNumber || 'N/A'] })), log.messageSid && (_jsxs("div", { className: "text-xs text-muted-foreground mt-1 font-mono", children: ["SID: ", log.messageSid] })), log.error && (_jsxs("div", { className: "text-xs text-red-600 dark:text-red-400 mt-1", children: ["Error: ", log.error] })), log.ip && (_jsxs("div", { className: "text-xs text-muted-foreground mt-1", children: ["IP: ", log.ip] }))] }) }), _jsxs("div", { className: "mt-2 space-y-2", children: [log.headers && Object.keys(log.headers).length > 0 && (() => {
