...
export function PhoneNumberSetup({ onNavigate }) {
    ...
    if (!isAdmin) {
        return (_jsx(Page, { title: "Phone Number Setup", description: "Configure SMS phone number for 2FA", children: _jsx(Alert, { variant: "error", title: "Access Denied", children: "Admin access required to configure phone numbers." }) }));
    }
    return (_jsxs(Page, { title: "Phone Number Setup", description: "Configure the shared phone number for SMS 2FA codes", children: [error && (_jsx(Alert, { variant: "error", title: "Error", children: error.message })), _jsx(Card, { children: _jsxs("div", { className: "p-6 space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "text-sm font-medium", children: "Phone Number" }), _jsx("p", { className: "text-xs text-muted-foreground mt-1 mb-2", children: "Enter the Twilio phone number in E.164 format (e.g., +1234567890). This number will be used for receiving 2FA codes for all vault items." }), _jsx(Input, { value: phoneNumber, onChange: (value) => setPhoneNumber(value), placeholder: "+1234567890" })] }), currentPhoneNumber && (_jsxs(Alert, { variant: "info", title: "Current Configuration", children: [_jsxs("p", { className: "text-sm mt-2", children: ["Current phone number: ", _jsx("code", { className: "font-mono", children: currentPhoneNumber })] }), _jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: ["Configure this number in Twilio to send webhooks to:", ' ', _jsx("code", { className: "font-mono text-xs", children: typeof window !== 'undefined'
