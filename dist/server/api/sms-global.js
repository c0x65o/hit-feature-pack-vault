...
export async function GET(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to get global phone number' }, { status: 500 });
    }
}
/**
...
export async function POST(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to set global phone number' }, { status: 500 });
    }
}
/**
...
export async function DELETE(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to delete global phone number' }, { status: 500 });
    }
}
