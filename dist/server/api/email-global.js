...
export async function GET(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to get global email address' }, { status: 500 });
    }
}
/**
...
export async function POST(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to set global email address' }, { status: 500 });
    }
}
/**
...
export async function DELETE(request) {
    try {
        ...
        return NextResponse.json({ error: 'Failed to delete global email address' }, { status: 500 });
    }
}
